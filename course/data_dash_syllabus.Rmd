...
## Instructor 
\begin{tabular}{ll}
\textbf{Name} & Brennan Bean, PhD and Kevin Moon, PhD \\
\textbf{Email} & brennan.bean@usu.edu \\
...
Additional supplementary materials will be provided in Canvas as necessary. Note that the online version of the textbook, which is the version you are encouraged to use, is free. 

## Introduction

This course will pair undergraduate students with two PhD students (Ben Shaw and Scout Jarman) to work on a real data problem related to water resource management in the Bear Lake. The PhD students will train machine learning and/or deep learning (ML/DL) on measurements of daily temperature and precipitation in the Bear Lake Watershed to predict annual min/max Bear Lake water elevation levels. These models will then be coupled with downscaled estimates of future climate projections to estimate Bear Lake water elevation levels through the end of the century. This course will focus on developing interactive data dashboards that embed these models and allow users to interactively explore changes in projected lake elevation levels to changes in modeling assumptions or future climate scenarios. These dashboards will be given to the Utah Department of Natural Resources to help them make informed decisions for the future of Bear Lake.
...
The final project in this class will be completed in groups. This makes your regular attendance critical to the collective success of the course. As such, you are required to attend all course sessions. To accommodate inevitable extenuating circumstances, all students are given three "excused" absences for the semester. Any absences beyond the three excused absences will result in a 60 point deduction to your attendance score (maximum deduction of 350 points).

The three excused absences are intended to cover family emergencies, illness, and university excused absences. This means that, should a student have to miss for a university excused absence, they only have TWO remaining excused absences for the semester, and not three. Please talk to the instructor during the first week if you anticipate having more than two university-excused absences during the semester.

### Final Project (300 points)

This class culminates in an interactive data dashboard suitable for presentation at USU's Spring Runoff Conference in March. Students will work in groups of three on these dashboards as overseen by a PhD student mentor. Students will be required to make regular contributions to the project and will be required to respond to multiple rounds of feedback from both the PhD student and the instructor. 

### Spring Runoff Conference Presentation (100 points)

Near the end of March (tentative dates of March 25-26), students will be required to present USU's Spring Runoff Conference and present their data dashboards at this conference. 

### Research Journal (150 points)

Each student will be required to keep track of their progress in a research journal. This journal should include 1-2 paragraphs of reflection for every day you work on the project (minimum of 3 entries per week). Things to write about include (1) what you worked on that day, (2) what you learned, (3) what you tried that didn't work, and (4) next steps for your work. These research journals will start once the group projects begin and you will be required to submit draft copies of the journal multiple times during the semester. 

### In-class assignments (100 points)

During the first 3-4 weeks of the semester there will be a series of in-class assignments designed to prepare you to start making a publishable data dashboard. These assignments are based on completion and can be submitted during or after class. Your lowest score in this assignment category will be dropped. 
